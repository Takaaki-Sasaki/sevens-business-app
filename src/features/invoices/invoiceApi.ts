...
const invoiceFields = 'id, organization_id, invoice_number, source_sale_id, customer_id, customer_name_snapshot, payment_method_id, payment_method_name_snapshot, subject, billing_month, due_date, subtotal_yen, tax_amount_yen, pre_order_discount_total_yen, order_discount_type, order_discount_amount_yen, order_discount_rate_basis_points, total_amount_yen, status, issued_at, issued_by, paid_at, cancelled_at, cancelled_by, cancellation_reason, deleted_at, created_by, created_at, updated_at';
